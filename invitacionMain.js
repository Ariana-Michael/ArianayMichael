...
document.getElementById("qrInvitado").innerHTML = "";

const qrImg = document.getElementById("qrInvitado");

qrImg.src =
"https://chart.googleapis.com/chart?chs=200x200&cht=qr&chl=" + encodeURIComponent(urlQR);
...
document.getElementById("mesaInvitado").innerText = data.mesa;
